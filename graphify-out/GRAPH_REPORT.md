...
1. `UserRepository` - 382 edges
2. `User` - 308 edges
3. `$()` - 291 edges
4. `10. Recent Important Changes` - 246 edges
5. `Base` - 243 edges
6. `t()` - 219 edges
7. `Message` - 211 edges
8. `DesktopAuthService` - 180 edges
9. `CourseMiniAppAccessService` - 158 edges
10. `CourseMiniAppEvent` - 149 edges
...
Cohesion: 0.01
Nodes (246): 10. Recent Important Changes, 2026-05-24 — Block grammar de-duplication, 2026-05-24 — Course block AI context, 2026-05-24 — Course level completion upgrade flow, 2026-05-24 — Dynamic course dialogue audio admin, 2026-05-24 — HSK3 block lesson completion, 2026-05-24 — HSK4 upper lesson localization quality, 2026-05-24 — HSK4 上 first 3 lessons block format (+238 more)
...
Cohesion: 0.06
Nodes (154): signingValue(), AppHandle, Entry, F, state, Option, Result, access_token() (+146 more)

### Community 7 - "Community 7"
Cohesion: 0.05
Nodes (50): androidx, ChallengeDto, RatingEntryDto, ReferralItemDto, ColorScheme, HskGlassIconButton(), StatChip(), pompColorScheme() (+42 more)
...
Cohesion: 0.04
Nodes (145): _admin_access_left(), admin_audio_list_handler(), admin_back_keyboard(), admin_broadcast_handler(), admin_channel_add_callback(), admin_channel_add_message(), admin_channel_delete_callback(), admin_channel_toggle_callback() (+137 more)
...
Cohesion: 0.03
Nodes (48): AndroidLinkStartRequest, AndroidLinkStatusRequest, AndroidRefreshRequest, AndroidRevokeRequest, create_android_auth_router(), Bearer-authenticated device-link adapter for the native Android client.  This mo, _unavailable(), create_desktop_auth_router() (+40 more)
...
Cohesion: 0.06
Nodes (59): SectionLimitBlock(), SectionLimitBlock(), AppUpdateBanner(), AppUpdateCard(), HskContentSkeleton(), HskListSkeletonRow(), SkeletonBlock(), GlassWash() (+51 more)

### Community 15 - "Community 15"
Cohesion: 0.13
Nodes (20): CourseEnergyDto, CourseGamificationDto, absoluteSafe(), ConfettiParticle, HskCelebrationStage(), HskConfettiField(), HskRayBurst(), HskStreakCelebration() (+12 more)
...
Cohesion: 0.05
Nodes (83): _actual_user_languages(), _complete_response(), _confirm_text(), _content_preview(), _course_miniapp_v2_template_state(), _edit_callback_panel(), _edit_stored_panel(), _edit_user_feedback_message() (+75 more)

### Community 19 - "Community 19"
Cohesion: 0.08
Nodes (41): AndroidHintDto, CourseHeader(), CourseScreen(), HintsViewModel, SectionHint(), onAllNodesWithContentDescriptionMatchingClose(), SectionHintTest, LimitGate (+33 more)
...
Cohesion: 0.06
Nodes (65): admin_help_link_handler(), admin_help_link_prompt(), admin_help_settings_callback(), _help_lang_label(), help_settings_back_keyboard(), help_settings_keyboard(), help_settings_text(), admin_stats_handler() (+57 more)
...
Cohesion: 0.07
Nodes (62): _body(), _access_token(), _access_token(), _access_token(), _access_token(), _access_token(), _access_token(), _body() (+54 more)
...
Cohesion: 0.06
Nodes (69): Boolean, FocusRows(), forLanguage(), GoalRows(), SetupOption, SetupRow(), SetupRows(), StudySetupCopy (+61 more)
...
Cohesion: 0.04
Nodes (15): CourseAttempt, Partner, PartnerCredit, PartnerPayout, PartnerReferral, RequiredChannel, CourseAttemptRepository, CoursePilotEventRepository (+7 more)
...
Cohesion: 0.02
Nodes (61): AbstractAsyncContextManager, admin_miniapp_course_ads_upload(), CourseAdCreative, CourseLessonAccessPolicy, CourseAdService, Reklama tilini normallashtiradi: uz/ru/tj yoki "all" (barchasi)., Media turi: "video" yoki "photo". Eski yozuvlarda NULL/bo'sh — video., Yuklangan faylni tur va kengaytmaga ajratadi.          `(media_type, ext)` qayta (+53 more)

### Community 56 - "Community 56"
Cohesion: 0.07
Nodes (19): AppUpdateBanner(), AppUpdateCard(), AndroidLessonAudioPlayer, File, MediaPlayer, AppUpdate, UpdateRelease, UpdateBannerContent() (+11 more)

### Community 57 - "Community 57"
Cohesion: 0.05
Nodes (101): _absolute_download_seo_urls(), admin_control_miniapp(), admin_miniapp_broadcast_upload_media(), admin_miniapp_notifications_media(), admin_miniapp_prices_qr_upload(), _apply_course_v3_progress_marks(), bot_username_value(), _checkout_attempt_id() (+93 more)
...
Cohesion: 0.23
Nodes (27): _delete_answer(), _edit_callback_block(), _edit_state_block(), _fmt_usd(), _lang(), open_partner_for_message(), partner_application_audience(), partner_application_channel() (+19 more)

### Community 61 - "Community 61"
Cohesion: 0.08
Nodes (20): _background_scheduler(), _send_subscription_expired_offer(), CourseUserNotification, clean_notification_text(), CourseNotificationService, local_day_dedupe(), _localized_copy(), notification_copy() (+12 more)
...
Cohesion: 0.09
Nodes (12): BotBlockStatusService, Tracks users who blocked the Telegram bot without messaging them., CourseReminderService, _reminder_keyboard(), reminder_tz_label(), reminder_tz_offset(), DailyResetService, BotBlockStatusServiceTests (+4 more)
...
Cohesion: 0.09
Nodes (31): VoiceSuggestionDto, VoiceWordDto, CallChat(), CallDock(), CallSettingRow(), CallSettingsSheet(), CallTopBar(), HintGroupLabel() (+23 more)
...
Cohesion: 0.08
Nodes (8): Bot, _uploaded_qr_file_id(), admin_bot_feedback_keyboard(), AdminNotifyService, PaymentQrCodeService, ReferralNotifyService, ScreenshotPayload, SubscriptionMiniAppService

### Community 77 - "Community 77"
Cohesion: 0.03
Nodes (43): AdContent(), AdScreen(), AdVideo(), AdUiState, AdViewModel, Factory, DrillResultDto, LinkUiState (+35 more)

### Community 78 - "Community 78"
Cohesion: 0.03
Nodes (56): android, openExternal(), rememberLimitGate(), UpdateWatch, openExternal(), rememberLimitGate(), UpdateWatch, AppWidgetManager (+48 more)

### Community 79 - "Community 79"
Cohesion: 0.09
Nodes (24): _MessageEditResponder, mode_free_qa_handler(), show_free_qa_level_choice(), _show_required_channel_for_pending_action(), force_sub_check(), _ForceSubTextProxy, _MessageEditResponder, _course_level_candidates() (+16 more)

### Community 80 - "Community 80"
Cohesion: 0.07
Nodes (21): ConversionFunnelService, Record a funnel event only if the same scoped event is absent.          This use, get_block_no_from_step(), is_block_quiz_step(), CourseMiniAppResultService, CourseTrialService, Qaysi dars shu o'quvchining birinchisi ekanini eslab qoladi.          Hech narsa, CourseTrialValueService (+13 more)
...
Cohesion: 0.11
Nodes (13): CommandObject, OnboardingStates, cmd_start(), _mode_choice_text(), process_language(), course_mode_entry_keyboard(), can_attach_start_referral(), onboarding_stage() (+5 more)
...
Cohesion: 0.06
Nodes (35): LinkedAccount, MiniAppPaletteTest, Flow, Long, CourseUser, AccessPill(), AppearancePicker(), AvatarNoteSheet() (+27 more)
...
Cohesion: 0.10
Nodes (10): normalize_manual_subscription_days(), Admin grant: userni paid-active qiladi va mavjud paid muddatni saqlaydi., Admin qo'lda beradigan obuna muddatini xavfsiz kun soniga aylantiradi., SubscriptionService, _user(), FunnelWiringTests, ManualSubscriptionDurationTests, _Session (+2 more)
...
Cohesion: 0.05
Nodes (20): date, _as_utc(), _button(), _canonical_band(), _d1_recovery_arm(), _d1_recovery_states(), _event_payload(), MotivationReminderService (+12 more)
...
Cohesion: 0.13
Nodes (15): lessonAccessible(), renderLessonNode(), renderRailLesson(), pick(), t(), ASSESSED_TYPES, briefText(), BUILDER_TYPES (+7 more)
...
Cohesion: 0.07
Nodes (71): _block_if_course_disabled(), _bot_from_respond(), course_audio_dialogue_handler(), course_audio_dialogue_n_handler(), course_audio_vocab_handler(), course_back_to_qa_handler(), course_command_handler(), course_continue_handler() (+63 more)

### Community 114 - "Community 114"
Cohesion: 0.06
Nodes (34): Markaziy limit dvigateli.  Bu dvigatel YANGI hisoblagich yaratmaydi. U bugungi j, Markaziy entitlement/limit dvigateli.  Bu paket "bu foydalanuvchi nima qila olad, access_expires_at(), _as_utc(), EntitlementState, has_active_pro_trial(), has_full_access(), is_billing_paid() (+26 more)
...
Cohesion: 0.09
Nodes (13): create_desktop_referral_router(), DesktopReferralError, _error_response(), _invite_link(), Bearer-authenticated desktop adapter for the referral programme.  ``ReferralServ, The same deep link the bot hands out, so attribution is identical.      The payl, _timezone_offset(), _build_referral_invite_text() (+5 more)
...
Cohesion: 0.05
Nodes (83): profile_menu_qa(), _course_locked_offer_text(), _ensure_active_course_access(), mode_qa_handler(), _send_course_access_offer(), _ai_draft_preview(), _answer_course_tutor_question(), _build_referral_limit_text() (+75 more)
...
Cohesion: 0.12
Nodes (52): FSMContext, admin_broadcast_info(), _actual_user_languages(), bc_activity_filter(), bc_button_action(), bc_button_none(), bc_button_text_default(), bc_button_text_message() (+44 more)
...
Cohesion: 0.03
Nodes (44): _bot_url(), _public_android_referral_item(), Mini App referral row without exposing Telegram or database ids., Deep link to the bot chat where the subscription Mini App is offered., Subscription is never sold inside the Android app.      The learner is handed of, _service_response(), _subscription_payload(), challenge_ref() (+36 more)
...
Cohesion: 0.05
Nodes (13): SimpleNamespace, RecordTests, _user(), CourseMiniAppLessonFlowBuilderTests, CourseMiniAppLessonFlowCompletionTests, StartedWindowIsReusedOnCompleteTests, CourseMistakeServiceTests, mistake() (+5 more)
...
Cohesion: 0.04
Nodes (25): create_miniapp_preferences_router(), PreferencesError, PreferencesRequest, Mini App o'quv preferensiyalari: kunlik vaqt, fokus va XP maqsadi.  Onboarding f, _validated_payload(), handle_invite_button(), CourseChallenge, OnboardingTipEvent (+17 more)
...
Cohesion: 0.09
Nodes (27): AbandonInput, create_android_assistant_router(), Authenticated Android chat API; media is transient and never logged., _access_token(), _validated_payload(), AssistantAssessment, AssistantConversation, AssistantRequest (+19 more)
...
Cohesion: 0.09
Nodes (38): android_panel(), android_panel_command(), ask_for_apk(), ask_for_update_url(), _back_keyboard(), _cancel_keyboard(), clear_update_url(), _confirm_keyboard() (+30 more)

### Community 182 - "Community 182"
Cohesion: 0.31
Nodes (14): feedback_callback_handler(), _paid_sub_question(), admin_feedback_reply_cancel_keyboard(), _column_keyboard(), feedback_dislike_keyboard(), feedback_dislike_label(), feedback_like_keyboard(), feedback_like_label() (+6 more)
...
Cohesion: 0.09
Nodes (9): Decimal, admin_visa_rate_set_callback(), PartnerBalance, PartnerService, CardCurrencyQuote, SubscriptionCurrencyService, downgrade(), _has_table() (+1 more)
...
Cohesion: 0.03
Nodes (61): create_admin_entitlements_router(), Admin Mini App uchun entitlement boshqaruvi.  Ikkita narsani boshqaradi:  * **Li, `admin_guard(request) -> (telegram_id, error_response)`., Base, DeclarativeBase, Cheklanadigan harakatlar ro'yxati.  Bugun har bo'lim o'z kalitini o'zi nomlaydi:, Shu harakat uchun paywall sirti., surface_for() (+53 more)
...
Cohesion: 0.24
Nodes (5): _as_utc(), Mukofot chiqquncha aktivatsiya qiladi, nechtasi ketganini qaytaradi.          0, AMALDAGI holat: konstanta 5 deydi, mukofot esa 6-aktivatsiyada keladi., Taklif qiluvchi + `invited_count` ta taklif qilingan odam.          Har bir takl, ReferralTrialContractTests

### Community 193 - "Community 193"
Cohesion: 0.11
Nodes (12): DictionaryDetail(), DictionaryHeader(), DictionaryList(), DictionaryMessage(), DictionaryScreen(), DictionarySkeleton(), PracticeRow(), WordRow() (+4 more)
...
Cohesion: 0.08
Nodes (28): create_miniapp_ads_router(), Reklama endpointlari — aynan ikkita joy uchun.  Ilgari bu yerda uchta narsa bor, CourseAdView, AdPlacementService, AdPlacementSettings, _clean_rule(), _default_rule(), default_settings() (+20 more)
...
Cohesion: 0.11
Nodes (46): command_language_keyboard(), get_course_keyboard_for_step(), _keyboard_for_step(), _lesson_selection_markup(), Har qanday step uchun to'g'ri klaviaturani qaytaradi (V1 + V2)., InlineKeyboardButton, InlineKeyboardMarkup, admin_payment_review_keyboard() (+38 more)
...
Cohesion: 0.10
Nodes (11): AIUsageBudget, AIUsageResult, AIUsageBudgetService, BudgetAccessResult, BudgetRecordResult, _as_utc(), 7 kunlik Pro trial — emailsiz, foydalanuvchining o'zi boshlaydi.  Email tasdiqla, Faol AI byudjeti bormi.          `create_fixed_budget` avval hamma faol byudjetn (+3 more)
...
Cohesion: 0.17
Nodes (30): applyLanguage(), bindEvents(), copy(), copyPublicTransfer(), detectedPlatform(), downloadUrl(), forPlatform(), init() (+22 more)
...
Cohesion: 0.06
Nodes (33): 14. AI Assistant Instructions, 2026-09-07 — Isolated local voice studio, 2026-09-09 — One limit authority: the admin panel, 2026-09-10 — Lesson start limit reservation and completion retry, 2026-09-10 — Practice gate latency guard, 2026-09-11 — Native Android limit overlay and panda reactions, 2026-09-11 — Native Android Smart Widget, 2026-09-13 — Native Android context-aware AI assistant (+25 more)
...
Cohesion: 0.08
Nodes (28): create_desktop_update_router(), AsyncBaseTransport, ManifestFetcher, The one stable file that says which Android build is current.  This is the Andro, _bounded_number(), DesktopReleaseManifest, DesktopReleaseManifestError, DesktopReleaseManifestService (+20 more)
...
Cohesion: 0.07
Nodes (27): 1. Ilova nima va qayerda, 2. Hozirgi holat, 3.10 Lug'at endi internetsiz to'liq ishlaydi — 2026-09-20, 3.11 Boshqa ochiqlar, 3.12 Uch xato foydalanuvchi suratlaridan (1.3.4) — TUZATILDI 2026-09-20, 3.13 Ilova umuman kompilyatsiya qilmasdi — TUZATILDI 2026-09-21, 3.14 Personajlar mashqqa ham chiqdi, murabbiy qatori qayta ishlandi — 2026-09-21, 3.1 ~~Mashq savollari buzuq~~ — TUZATILDI 2026-09-15 (+19 more)
...
Cohesion: 0.07
Nodes (5): AsyncSession, PaymentQrCode, SubscriptionPrice, PaymentQrCodeRepository, SubscriptionPriceRepository
...
Cohesion: 0.04
Nodes (47): AndroidStudyPreferencesRequest, create_android_course_router(), One progressive-personalization answer, matching Mini App preferences., AndroidCourseService, Return the checked-in Starter 0 payload used by the Mini App., Persist Starter 0 completion through the Mini App event contract., Return the canonical onboarding state for the authenticated learner., Complete onboarding through the exact service used by the Mini App. (+39 more)
...
Cohesion: 0.05
Nodes (13): LessonAudioPlayer, NoopSkipDao, FakeLessonApi, FakeLessonAudioPlayer, FakeResumeStore, lessonPayload(), LessonViewModelTest, NoopDao (+5 more)
...
Cohesion: 0.13
Nodes (8): CourseMiniAppOnboardingService, Starter 0 is mandatory only on a beginner's first lesson start., CourseMiniAppOnboardingFlowTests, CourseMiniAppOnboardingValidationTests, CourseModeEntryKeyboardTests, _FakeForceSubState, RequiredChannelPromptTests, RequiredChannelResumeTests
...
Cohesion: 0.30
Nodes (9): GoalLeft, Mood, StreakAtRisk, WidgetMood, WidgetPrompt, WidgetReaction, WidgetSnapshot, WidgetStateResolver (+1 more)
...
Cohesion: 0.24
Nodes (4): CourseProgress, CourseProgress, _count_json_items(), _level_candidates()
...
Cohesion: 0.15
Nodes (14): admin_miniapp_desktop_promo_media_clear(), admin_miniapp_desktop_promo_media_upload(), BotSetting, BotSettingRepository, _bool_map(), _bounded_daily_limit(), desktop_app_promo_media_available(), desktop_app_promo_media_full_path() (+6 more)
...
Cohesion: 0.06
Nodes (30): datetime, _utcnow(), _count_completed_book_lessons(), _count_distinct(), _count_events(), _count_unique_users(), _event_conditions(), feature_usage_stats() (+22 more)
...
Cohesion: 0.06
Nodes (29): AIUsageEvent, Payment, PortfolioTransaction, SubscriptionEntryEvent, audit(), main(), Read-only, aggregate AI ledger audit. No credentials or learner IDs in output., run() (+21 more)
...
Cohesion: 0.07
Nodes (23): ActionLimit, _clean_plan(), _clean_rule(), _clean_trial(), config_from_payload(), default_config(), _default_limit(), _defaults_as_rules() (+15 more)
...
Cohesion: 0.33
Nodes (5): Android Smart Widget, Change points, Operational contract, Panda qachon nima deydi, QA commands
...
Cohesion: 0.05
Nodes (13): MiniAppAdvertisingLivesInOneSectionTests, NoStaleCopyTests, Admin panelda ishlamaydigan boshqaruv turmasin.  Foydalanuvchi buni aniq aytdi:, Mini App reklamasi to'rt joyga bo'linib ketgan edi.      Foydalanuvchi buni aniq, Botdagi reklama xabari Mini App reklamasi EMAS.          Boshqa jadval, boshqa k, Tanlangan turga aloqasi yo'q maydon ko'rinmasin.      Forma barcha kataklarni bi, Rolik yopish vaqtini ham, kunlik chegarani ham belgilamaydi.      Forma ikkalasi, Panelda ko'rinmagan chegara — jimgina o'zgaradigan chegara.      `save_config` p (+5 more)
...
Cohesion: 0.15
Nodes (8): normalize_skill(), So'z darajasidagi interval takrori: mashq nimani berishini hal qiladi.  Ilgari m, Shu ko'nikma bo'yicha barcha yozuvlar. Lug'at hajmi bilan         chegaralangan, Interval takrori qoidasi.          To'g'ri javob so'zni faqat MUDDATI KELGAN bo', Mashq natijasini yozadi. Yozilgan so'zlar sonini qaytaradi.          Bu HECH QAC, Mashq uchun so'zlar + kontekst. Xato bo'lsa bo'sh ro'yxat.          Bo'sh ro'yxa, Natijalarni yozadi, mintaqani o'zi aniqlab., `(band, joriy qism, mintaqa siljishi)` — endpointlar uchun.          Router yupq
...
Cohesion: 0.09
Nodes (27): ChallengeQuestionDto, challengeAssistantContext(), courseAssistantContext(), dictionaryAssistantContext(), lessonAssistantContext(), practiceAssistantContext(), profileAssistantContext(), ratingAssistantContext() (+19 more)

### Community 487 - "Community 487"
Cohesion: 0.05
Nodes (47): HskCelebrationPanda(), ContinuousCourseTrail(), MiniAppScenery(), courseLevelLabel(), courseNodeLabel(), CurrentBubble(), GoalRing(), pathOffset() (+39 more)
...
Cohesion: 0.50
Nodes (3): Chatdagi menyu barni (reply keyboard) yetkazish.  Muammo: kurs yo'lidan kirgan u, Menyu barni yuboradi. Yuborilgan bo'lsa True qaytaradi.      `once=True` — ilgar, send_menu_bar()
...
Cohesion: 0.31
Nodes (10): _admin_miniapp_management_payload(), _admin_user_card_payload(), _admin_user_payload(), _mini_dt(), _mini_label(), _mini_method_label(), _mini_plan_label(), _mini_usd() (+2 more)
...
## Knowledge Gaps
- **849 isolated node(s):** `WORDS`, `PendingLink`, `PompTextStyles`, `PracticeTool`, `LinkStartResponse` (+844 more)
...
- **Why does `$()` connect `Community 96` to `Community 320`, `Community 257`, `Community 197`, `Community 102`, `Community 6`, `Community 229`, `Community 103`, `Community 72`, `Community 107`, `Community 17`, `Community 243`, `Community 119`?**
...
- **Are the 164 inferred relationships involving `User` (e.g. with `CourseAdVideoError` and `LessonAccessService`) actually correct?**
  _`User` has 164 INFERRED edges - model-reasoned connections that need verification._
