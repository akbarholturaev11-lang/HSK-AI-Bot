...
LESSON = {
    ...
    "intro_text": json.dumps({
        ...
        "tj": "Дар дарси аввал шумо шиносоӣ бо хитоиро меомӯзед. Ин дарс 6 калимаи нав, 3 гуфтугӯ ва қоидаҳои асосии талаффузро дар бар мегирад.",
    }, ensure_ascii=False),
    ...
    "homework_json": json.dumps([
        {
            ...
            "instruction_tj": "Бо истифодаи калимаҳои зерин 2 гуфтугӯ нависед:",
            "words": ["你好", "您好", "对不起", "没关系"],
            "example": "A: 对不起！B: 没关系！",
        },
        {
