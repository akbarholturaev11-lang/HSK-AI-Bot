    ...
    "grammar_json": json.dumps([
        {
            ...
            "rule_tj": (
                "Ин сохт имкониятро ё набудани имконияти иҷрои амалро ифода мекунад.\n"
        ...
        },
        {
            ...
            "rule_tj": (
                "'N+呢？' — сохти саволии хеле кӯтоҳ, дар бораи ҷой мепурсад.\n"
                "Маъно: '...куҷост? ...чист?'\n"
                "Масалан:\n"
