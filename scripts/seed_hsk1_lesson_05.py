...
LESSON = {
    ...
    "intro_text": json.dumps({
        ...
        "tj": "Дар дарси панҷум шумо пурсидан ва гуфтани синну сол, шумораи аъзоёни оиларо омӯхта, рақамҳоро то 100 меомӯзед. 10 калимаи нав, 3 гуфтугӯ.",
    }, ensure_ascii=False),
    ...
    "grammar_json": json.dumps([
        {
            ...
            "rule_tj": (
                ...
                "Сохт: Мубтадо + 有 + 几 + Калимаи шуморавӣ + Исм?\n\n"
                "Мисол:\n"
