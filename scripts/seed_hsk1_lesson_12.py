...
LESSON = {
    ...
    "goal": json.dumps({
        ...
        "tj": "Сухан дар бораи обу ҳаво, калимаи суолии 怎么样 ва сохти 太...了",
    }, ensure_ascii=False),
    "intro_text": json.dumps({
        ...
        "tj": "Дар дарси дувоздаҳум шумо ёд мегиред, ки дар бораи обу ҳаво сухан ронед, бо 怎么样 ҳолро пурсед ва сохти 太...了 -ро истифода баред. 13 калимаи нав, 3 гуфтугӯ.",
    }, ensure_ascii=False),
