...
LESSON = {
    ...
    "goal": json.dumps({
        ...
        "tj": "Дар бораи шахсони сеюм гап задан, ифодаи соҳибӣ бо 的 ва истифодаи калимаҳои саволии 谁/哪",
    }, ensure_ascii=False),
    "intro_text": json.dumps({
        ...
        "tj": "Дар дарси чорум шумо дар бораи шахсони сеюм (вай/ӯ) гап задан, ифодаи соҳибӣ бо ёрии ҳарфи 的 ва истифодаи калимаҳои саволии 谁/哪 -ро меомӯзед. 10 калимаи нав, 3 гуфтугӯ.",
    }, ensure_ascii=False),
    ...
    "grammar_json": json.dumps([
        {
            ...
            "rule_tj": (
                "的(de) — соҳибӣ ё алоқаро ифода мекунад.\n"
                "Сохт: Исм/Ҷонишин + 的 + Исм\n\n"
                "Мисол:\n"
                "我的老师 — муаллими ман\n"
                "她的朋友 — дӯсти вай\n\n"
