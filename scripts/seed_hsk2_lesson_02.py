    ...
    "grammar_json": json.dumps([
        {
            ...
            "rule_tj": "Саволҳое, ки бо 是不是 сохта мешаванд. Бо ёрии ин қолиб гумонии чизе пурсида мешавад. 是不是 метавонад дар аввал ё миёнаи ҷумла биояд. Ҷавоб бо 'бале' ё 'не' дода мешавад.",
            "examples": [
