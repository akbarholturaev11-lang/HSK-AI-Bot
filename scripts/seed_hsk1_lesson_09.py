...
LESSON = {
    ...
    "goal": json.dumps({
        ...
        "tj": "Пурсидан дар бораи ҷой ва ҷои кор, феъл ва пешояндаи 在",
    }, ensure_ascii=False),
    "intro_text": json.dumps({
        ...
        "tj": "Дар дарси нӯҳум шумо ёд мегиред, ки кӣ дар куҷо аст, дар куҷо кор мекунем ва ду истифодаи 在 -ро. 14 калимаи нав, 3 гуфтугӯ.",
    }, ensure_ascii=False),
