...
LESSON = {
    ...
    "intro_text": json.dumps({
        ...
        "tj": "Дар дарси сездаҳум шумо ёд мегиред, ки амалҳои ҳоло ҷоришударо чӣ тавр баён кунед, сохти 在...呢 ва зарраи 吧 -ро истифода баред. 11 калимаи нав, 3 гуфтугӯ.",
    }, ensure_ascii=False),
    ...
    "grammar_json": json.dumps([
        {
            ...
            "rule_tj": (
                ...
                "Сохти 1: 在 + Феъл (+ Пуркунанда)\n"
                "Сохти 2: Феъл + Пуркунанда + 呢\n"
                "Сохти 3: 在 + Феъл + 呢 (таъкидӣ)\n\n"
                "Намуна:\n"
    ...
    "homework_json": json.dumps([
        ...
        },
        {
            ...
            "instruction_tj": "Гуфтугӯи телефонии бо дӯст нависед (4 саф, аз 喂 оғоз кунед):",
            "example": "A: 喂，你在做什么呢？\nB: 我在___呢。\nA: ___也在___吗？\nB: 她___，她在___呢。",
        }
    ], ensure_ascii=False),
