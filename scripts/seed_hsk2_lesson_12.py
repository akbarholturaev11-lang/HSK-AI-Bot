    ...
    "grammar_json": json.dumps([
        {
            ...
            "rule_tj": "Иловаи ҳолат баъд аз феъл бо зарраи '得(de)' омада, тавсиф мекунад амал чӣ тавр иҷро мешавад ё натиҷааш чист. Сохт: Феъл + 得 + сифат/ҳолат. Агар феъл иловаи хос дошта бошад, феъл такрор мешавад: 做饭做得好. Инкор: баъд аз '得' '不' гузошта мешавад: 做得不好.",
            "examples": [
        ...
        },
        {
            ...
            "rule_tj": "Ҳангоми муқоисаи сохтҳои феълӣ 'bǐ' чунин истифода мешавад: A + 比 + B + феъл + 得 + сифат. Ё феъл такрор мешавад: A + 比 + B + феъл + феъл + 得 + сифат. Масалан: 我妻子比我做饭做得好. Метавон фарқро ҳам зиёд кард: 比我早起一个小时.",
            "examples": [
