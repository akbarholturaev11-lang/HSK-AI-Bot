...
LESSON = {
    ...
    "intro_text": json.dumps({
        ...
        "tj": "Дар дарси ёздаҳум шумо ёд мегиред, ки вақтро чӣ тавр гӯед, зарфҳои вақтро истифода баред ва вақтро бо калимаи 前 баён кунед. 12 калимаи нав, 3 гуфтугӯ.",
    }, ensure_ascii=False),
    ...
    "grammar_json": json.dumps([
        ...
        },
        {
            ...
            "rule_tj": (
                ...
                "Сохти 1: Муб. + Вақт + Феъл\n"
                "妈妈六点做饭。— Модар соати шаш хӯрок мепазад.\n\n"
                "Сохти 2: Вақт + Муб. + Феъл\n"
