...
EXPECTED = {
    ...
    18: {
        ...
        "dialogues": [
            ...
            [
                "不同的国家有不同的文化，每种文化都有自己的特点。到了一个新环境，你会觉得什么都很新鲜，而且还会觉得有点儿奇怪：有些国家的人名写在姓前面，有些国家的人名写在姓后面，但是只要经过一段时间，就会慢慢地习惯。",
            ],
        ],
    },
    19: {
...
def verify() -> None:
    ...
    print("HSK3 lessons 1-20 vocabulary/dialogues match the PDF canonical list.")
