...
LESSON = {
    ...
    "grammar_json": json.dumps([
        ...
        },
        {
            ...
            "title_tj": "Сохти '一……也/都+不/没……' — инкори қавӣ",
            "rule_uz": (
            ...
            "rule_tj": (
                "Ин сохт инкори мутлақро ифода мекунад: 'ҳатто як...ҳам нест'.\n"
                "Сохт: 一 + шумор+исм + 也/都 + 不/没 + феъл\n"
    ...
    "homework_json": json.dumps([
        {
            ...
            "instruction_tj": "Бо истифода аз сохти '一……也/都+不/没……' 3 ҷумла тартиб диҳед. Аз ҳаёти рӯзмарра мисол овардед.",
