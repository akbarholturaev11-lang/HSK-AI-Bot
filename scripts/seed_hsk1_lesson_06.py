...
LESSON = {
    ...
    "intro_text": json.dumps({
        ...
        "tj": "Дар дарси шашум шумо ифодаи қобилиятро бо феъли модалии 会, ҷумлаҳо бо сифати хабарӣ ва калимаи саволии 怎么 -ро меомӯзед. 12 калимаи нав, 3 гуфтугӯ.",
    }, ensure_ascii=False),
    "vocabulary_json": json.dumps([
        {"no": 1,  "zh": "会",   "pinyin": "huì",    "pos": "mod.",
         "uz": "qila olmoq (o'rganish orqali)",
         "ru": "мочь, уметь (через обучение)",
         "tj": "тавонистан (бо ёрии омӯзиш)"},
