...
LESSON = {
    ...
    "intro_text": json.dumps({
        ...
        "tj": "Дар дарси сеюм шумо исм, миллат ва касби худро ба забони чинӣ гуфтанро меомӯзед. 12 калимаи нав, 3 гуфтугӯ ва грамматикаи ҷумлаҳои 是.",
    }, ensure_ascii=False),
    ...
    "grammar_json": json.dumps([
        {
            ...
            "rule_tj": (
                ...
                "Сохт: Мубтадо + 是 + Исм/Гурӯҳи исмӣ\n"
