...
LESSON = {
    ...
    "goal": json.dumps({
        ...
        "tj": "Баёни ҷой, ҷумлаҳои 有, феъли модалии 能 ва пайвандаки 和",
    }, ensure_ascii=False),
    "intro_text": json.dumps({
        ...
        "tj": "Дар дарси даҳум шумо ёд мегиред, ки чизҳо дар куҷоянд, бо 有 мавҷудиятро баён кунед, феъли модалии 能 ва пайвандаки 和 -ро истифода баред. 14 калимаи нав, 3 гуфтугӯ.",
    }, ensure_ascii=False),
