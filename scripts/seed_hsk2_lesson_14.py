...
LESSON = {
    ...
    "grammar_json": json.dumps([
        ...
        },
        {
            ...
            "rule_tj": "'Cì' (маротиба, бор) иловаи миқдорӣ аст, баъд аз феъл меояд ва нишон медиҳад амал чанд маротиба иҷро шудааст. Сохт: феъл + '过' + рақам + '次'. Масалан: 去过两次 (ду маротиба рафтаам).",
            "examples": [
