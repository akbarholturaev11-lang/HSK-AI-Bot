...
from scripts.hsk2_block_metadata import apply_hsk2_block_metadata
    ...
    "grammar_json": json.dumps([
        ...
        },
        {
            ...
            "rule_tj": (
                ...
                "Ин сохт давомнокӣ ва такрорпазириро таъкид мекунад."
            ),
            "examples": [
        ...
        },
        {
            ...
            "rule_tj": (
                "Дар сохти '因为……所以……' сабаб ва натиҷа нишон дода мешавад.\n"
    ...
    "homework_json": json.dumps([
        {
            ...
            "instruction_tj": "Бо истифода аз сохти '因为……所以……' 4 ҷумла тартиб диҳед. Аз ҳаёти рӯзмарраи худ сабаб ва натиҷа овардед.",
...
apply_hsk2_block_metadata(LESSON)
