...
from app.api.miniapp_ads import create_miniapp_ads_router
...
app.include_router(
    create_ios_social_router(
        session_factory=async_session_maker,
        settings_obj=settings,
    )
)
app.include_router(
    create_ios_assistant_router(session_factory=async_session_maker, settings_obj=settings)
)
app.include_router(
