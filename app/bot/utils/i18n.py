TEXTS = {
    "tj": {
        ...
        "subscription_miniapp_entry_text": "<b>💎 Обуна</b>\n\n<blockquote>Обуна гиред ва AI ҷавобҳо, курс, фото, voice, quiz ва таҳлили хатоҳо бе маҳдудияти сахт дастрас мешаванд.\n\nДар mini app тариф, усули пардохт, кишвари корт ва маблағи дақиқ нишон дода мешавад.</blockquote>",
    ...
    "ru": {
        ...
        "subscription_miniapp_entry_text": "<b>💎 Подписка</b>\n\n<blockquote>Подписка открывает AI-ответы, курс, фото, voice, quiz и разбор ошибок без жёстких ограничений.\n\nВ mini app вы выберете тариф, способ оплаты, страну карты и увидите точную сумму.</blockquote>",
    ...
    "uz": {
        ...
        "subscription_miniapp_entry_text": "<b>💎 Obuna</b>\n\n<blockquote>Obuna AI javoblar, kurs, foto, voice, quiz va xato tahlilini qattiq cheklovlarsiz ochadi.\n\nMini app ichida tarif, to‘lov usuli, karta davlati va aniq summa ko‘rsatiladi.</blockquote>",
