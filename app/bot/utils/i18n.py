TEXTS = {
    "tj": {
        ...
        "access_daily_limit_reached": "<b>📊 Лимити имрӯзаи шумо ба анҷом расид</b>\n\n<blockquote>Фардо лимит аз нав мешавад.\n\nДӯстро даъват кунед: ҳар даъвати фаъол +5 савол медиҳад. Агар 10 даъвати фаъол ҷамъ кунед, 3 рӯз дастрасии active мегиред.</blockquote>",
        ...
        "referral_daily_limit_offer": "<b>📊 Лимити имрӯзаи шумо ба анҷом расид</b>\n\n<blockquote>Дӯстро даъват кунед: ҳар даъвати фаъол +5 савол медиҳад.\n\nАгар {required} даъвати фаъол ҷамъ кунед, {days} рӯз active мешавед. Баъд аз анҷоми ин муддат ҳисоб аз 0 сар мешавад.\n\nҲисоби ҳозира: {count}/{required}</blockquote>",

        "access_daily_image_limit_reached": "<b>📸 Лимити сурат ба анҷом расид</b>\n\n<blockquote>Лимити сурати имрӯзаи шумо ба анҷом расид.\n\nОбуна гиред ё 10 даъвати фаъол ҷамъ кунед ва 3 рӯз active шавед.</blockquote>",
        "referral_image_limit_offer": "<b>📸 Лимити сурат ба анҷом расид</b>\n\n<blockquote>Обуна гиред ё дӯстонро даъват кунед.\n\nҲар даъвати фаъол +5 савол медиҳад. Агар {required} даъвати фаъол ҷамъ кунед, {days} рӯз active мешавед.\n\nҲисоби ҳозира: {count}/{required}</blockquote>",
        ...
        "referral_trial_access_unlocked": "<b>✅ {days} рӯз active кушода шуд</b>\n\n<blockquote>Шумо 10 даъвати фаъол ҷамъ кардед. Ин обунаи пулакӣ нест, бинобар ин лимитҳо боқӣ мемонанд.\n\nБаъд аз анҷоми муддат ҳисоб барои ин функция аз 0 сар мешавад.</blockquote>",
        "referral_invite_text": "<b>Ин силкаи даъвати шумост:</b>\n<code>{link}</code>\n\n<blockquote>Агар дӯстатон бо ин силка ворид шуда, ба бот 2 хабар фиристад, шумо +5 саволи бонусӣ мегиред.\n\n{required} даъвати фаъол = {days} рӯз active. Ин обунаи пулакӣ нест, лимитҳо боқӣ мемонанд.\n\nҲисоби ҳозира: {count}/{required}</blockquote>",
    ...
    "ru": {
        ...
        "access_daily_limit_reached": "<b>📊 Ваш лимит на сегодня закончился</b>\n\n<blockquote>Завтра лимит обновится.\n\nПригласите друга: каждое активное приглашение дает +5 вопросов. Если соберете 10 активных приглашений, получите active-доступ на 3 дня.</blockquote>",
        ...
        "referral_daily_limit_offer": "<b>📊 Ваш лимит на сегодня закончился</b>\n\n<blockquote>Пригласите друга: каждое активное приглашение дает +5 вопросов.\n\nЕсли соберете {required} активных приглашений, получите active-доступ на {days} дня. После окончания срока счетчик этой функции начнется с 0.\n\nСейчас: {count}/{required}</blockquote>",

        "access_daily_image_limit_reached": "<b>📸 Лимит изображений исчерпан</b>\n\n<blockquote>Ваш лимит на изображения на сегодня закончился.\n\nОформите подписку или соберите 10 активных приглашений и получите active-доступ на 3 дня.</blockquote>",
        "referral_image_limit_offer": "<b>📸 Лимит изображений исчерпан</b>\n\n<blockquote>Оформите подписку или пригласите друзей.\n\nКаждое активное приглашение дает +5 вопросов. Если соберете {required} активных приглашений, получите active-доступ на {days} дня.\n\nСейчас: {count}/{required}</blockquote>",
        ...
        "referral_trial_access_unlocked": "<b>✅ Active-доступ открыт на {days} дня</b>\n\n<blockquote>Вы собрали 10 активных приглашений. Это не платная подписка, поэтому лимиты остаются.\n\nПосле окончания срока счетчик этой функции начнется с 0.</blockquote>",
        "referral_invite_text": "<b>Это ваша ссылка для приглашения:</b>\n<code>{link}</code>\n\n<blockquote>Если друг войдет по этой ссылке и отправит боту 2 сообщения, вы получите +5 бонусных вопросов.\n\n{required} активных приглашений = active-доступ на {days} дня. Это не платная подписка, лимиты остаются.\n\nСейчас: {count}/{required}</blockquote>",
    ...
    "uz": {
        ...
        "access_daily_limit_reached": "<b>📊 Bugungi limitingiz tugadi</b>\n\n<blockquote>Ertaga limit yangilanadi.\n\nDo‘stingizni taklif qiling: har bir active referral +5 savol beradi. 10 ta active referral yig‘sangiz, 3 kun active kirish olasiz.</blockquote>",
        ...
        "referral_daily_limit_offer": "<b>📊 Bugungi limitingiz tugadi</b>\n\n<blockquote>Do‘stingizni taklif qiling: har bir active referral +5 savol beradi.\n\n{required} ta active referral yig‘sangiz, {days} kun active bo‘lasiz. Bu muddat tugagach shu funksiya hisobi 0 dan boshlanadi.\n\nHozirgi hisob: {count}/{required}</blockquote>",

        "access_daily_image_limit_reached": "<b>📸 Rasm limiti tugadi</b>\n\n<blockquote>Bugungi rasm limiti tugadi.\n\nObuna oling yoki 10 ta active referral yig‘ib, 3 kun active bo‘ling.</blockquote>",
        "referral_image_limit_offer": "<b>📸 Rasm limiti tugadi</b>\n\n<blockquote>Obuna oling yoki do‘stlaringizni taklif qiling.\n\nHar bir active referral +5 savol beradi. {required} ta active referral yig‘sangiz, {days} kun active bo‘lasiz.\n\nHozirgi hisob: {count}/{required}</blockquote>",
        ...
        "referral_trial_access_unlocked": "<b>✅ {days} kun active kirish ochildi</b>\n\n<blockquote>Siz 10 ta active referral yig‘dingiz. Bu pullik obuna emas, shuning uchun limitlar saqlanadi.\n\nMuddat tugagach shu funksiya hisobi 0 dan boshlanadi.</blockquote>",
        "referral_invite_text": "<b>Bu sizning taklif silkangiz:</b>\n<code>{link}</code>\n\n<blockquote>Do‘stingiz shu silka orqali kirib, botga 2 ta xabar yuborsa, siz +5 bonus savol olasiz.\n\n{required} ta active referral = {days} kun active kirish. Bu pullik obuna emas, limitlar saqlanadi.\n\nHozirgi hisob: {count}/{required}</blockquote>",
