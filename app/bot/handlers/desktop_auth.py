...
_COPY = {
    "uz": {
        ...
        "enter_code": (
            ...
            "Pomp HSK AI ilovasida ko‘rsatilgan 8 belgili kodni "
        ...
        "ok_mobile": (
            ...
            "Pomp HSK AI ilovasiga qayting — hisobingiz avtomatik ochiladi."
        ),
    ...
    "ru": {
        ...
        "ok_mobile": (
            ...
            "Вернитесь в приложение Pomp HSK AI — аккаунт откроется автоматически."
        ),
    ...
    "tj": {
        ...
        "enter_code": (
            ...
            "Рамзи 8-аломатии дар барномаи Pomp HSK AI "
        ...
        "ok_mobile": (
            ...
            "Ба барномаи Pomp HSK AI баргардед — ҳисоб худкор кушода мешавад."
        ),
