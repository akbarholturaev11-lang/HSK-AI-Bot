...
(function(){
  ...
  +'.caa-ov.done .caa-top{display:none}'
  +'.caa-ov.done .caa-box{grid-template-rows:minmax(0,1fr) auto}'
  +'.caa-ov.done .caa-meta>b,.caa-ov.done .caa-meta>small,.caa-ov.done .caa-cta0{display:none}'
  +'.caa-ov.done .caa-benefits{display:none}'
  +'.caa-ov.done .caa-sub{gap:8px;padding:14px}'
  +'.caa-ov.done .caa-sub-t{font-size:14px;margin:0 0 2px}'
  +'.caa-ov.done .caa-pay,.caa-ov.done .caa-cta.ghost{padding:12px;font-size:14px;border-radius:12px}'
  ...
  +'.caa-ov.done .caa-promo{display:flex}'
  ...
  function ensureDom(){
    ...
    ov.innerHTML = ''
      ...
      +'<div class="caa-sub" hidden><p class="caa-sub-t"></p><div class="caa-benefits"></div>'
      +'<button class="caa-cta caa-pay"></button><button class="caa-cta ghost caa-cont"></button></div>'
      +'</div></div>';
    ...
    els = {ov:ov, box:q(".caa-box"), label:q(".caa-label"), count:q(".caa-count"), vwrap:q(".caa-vwrap"),
      ...
      subTitle:q(".caa-sub-t"), benefits:q(".caa-benefits"), pay:q(".caa-pay"), cont:q(".caa-cont")};
  ...
  function closeOverlay(){
    ...
    stopPromo();els.ov.classList.remove("done");setStatus("");
    ...
    return new Promise(function(resolve,reject){
      fetchAds(placement).then(function(ads){
        ...
        function playAd(i){
          ...
          stopPromo();els.ov.classList.remove("done");
          ...
          function draw(){
            ...
            else{try{video.pause()}catch(e){}els.vwrap.style.display="none";els.ov.classList.add("done");startPromo();STATE.ready=true;els.cta0.style.display="none";setSubVisible(true);}
          }
