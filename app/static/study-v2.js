...
window.addEventListener("message",event=>{const data=event?.data||{};if(data.type==="hsk_voice_completed"){syncGamification(data.reward,true);renderAll()}else if(data.type==="hsk_voice_close"){showPage("home")}});
