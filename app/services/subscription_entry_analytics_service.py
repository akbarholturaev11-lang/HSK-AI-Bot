...
class SubscriptionEntryAnalyticsService:
    SOURCE_GROUP_LABELS = {
        ...
        "android_practice_mistakes": "Android · Xatolar mashqi limiti",
        "android_recognition_limit": "Android · Ieroglif mashqi limiti",
        "android_pronunciation_limit": "Android · Talaffuz limiti",
        "android_voice_limit": "Android · Voice limiti",
